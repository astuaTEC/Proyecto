...
public class Conexion_Cliente extends Thread implements Observer {
	 ...
	 */
	public Conexion_Cliente(Socket socket, MensajesChat mensajes) {
	...
	public void run() {
		...
		while(conectado) {
			try {
				...
				// Codigo del mensaje que le vamos 	a enviar a los clientes
				String JsonServer = Transformador.convertJavaToJson("Molde");
