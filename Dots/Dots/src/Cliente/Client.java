...
public class Client {
	...
	private Molde m = new Molde();  // Molde en donde se van a guardar los datos que se desean enviar.
	...
	public void recibirMensajesServidor(){
        ...
        while (conectado) {
            try {
                ...
                // se guarda el mensaje del servidor en la clase mensaje
                m.setLlegada_Servidor(mensaje);
	...
	public static void main(String[] args) {
		Client c = new Client(); // Se crea una instancia de Client.
